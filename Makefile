...
#	make model FC="pgf77" FLGS="-I$(INC) -O2 -tp k8-32 -pc 64 -Kieee -Mdalign -Mextend -Mnoframe -byteswapio -Wl,-Bstatic" TARGT="CAMx.$(DOMAIN).linux" DUM=dummy
	make model FC="pgf77" FLGS="-I$(INC) -O2 -tp k8-64 -pc 64 -L$(LD_LIBRARY_PATH) -Mlarge_arrays -mcmodel=medium -Kieee -Mdalign -Mextend -Mnoframe -byteswapio" TARGT="CAMx.$(DOMAIN).linux" DUM=dummy
