...
c
      ...
      parameter(simdays = 9)  ! Num of Simulation Days
...
c
      ...
      scenario = 'PMCAMx2008_BASE_lay'   !output folder
      scenario2 = 'PMCAMx2008_BASE'      !input file
...
c	PM2.5 = OC + PEC/2 + CRST + PCL + NA + ~PH2O + PNH4 + PNO3 + PSO4        
	  sconh(87,i,j) = sconh(86,i,j) + sconh(71,i,j)/2 + sconh(72,i,j)
