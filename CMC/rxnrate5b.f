...
c
      ...
      r( 13) = rk( 13)*cncrad(kN2O5)*H2O*nflag
      ...
      r( 25) = rk( 25)*cncrad(kOH)*conc(kNO2)*nflag
      ...
      r( 39) = rk( 39)*cncrad(kNO3)*cncrad(kHO2)*nflag
      ...
      r(129) = rk(129)*conc(kHCHO)*cncrad(kNO3)*nflag
      r(130) = rk(130)*conc(kCCHO)*cncrad(kOH)
      r(131) = rk(131)*conc(kCCHO)
      r(132) = rk(132)*conc(kCCHO)*cncrad(kNO3)*nflag
      r(133) = rk(133)*conc(kRCHO)*cncrad(kOH)
      r(134) = rk(134)*conc(kRCHO)
      r(135) = rk(135)*conc(kRCHO)*cncrad(kNO3)*nflag
      ...
      r(148) = rk(148)*conc(kGLY)*cncrad(kNO3)*nflag
      r(149) = rk(149)*conc(kMGLY)
      r(150) = rk(150)*conc(kMGLY)*cncrad(kOH)
      r(151) = rk(151)*conc(kMGLY)*cncrad(kNO3)*nflag
      r(152) = rk(152)*conc(kBACL)
      r(153) = rk(153)*conc(kPHEN)*cncrad(kOH)
      r(154) = rk(154)*conc(kPHEN)*cncrad(kNO3)*nflag
      r(155) = rk(155)*conc(kCRES)*cncrad(kOH)
      r(156) = rk(156)*conc(kCRES)*cncrad(kNO3)*nflag
      r(157) = rk(157)*conc(kNPHE)*cncrad(kNO3)*nflag
      r(158) = rk(158)*conc(kBALD)*cncrad(kOH)
      r(159) = rk(159)*conc(kBALD)
      r(160) = rk(160)*conc(kBALD)*cncrad(kNO3)*nflag
      r(161) = rk(161)*conc(kMETH)*cncrad(kOH)
      r(162) = rk(162)*conc(kMETH)*conc(kO3)
      r(163) = rk(163)*conc(kMETH)*cncrad(kNO3)*nflag
      ...
      r(172) = rk(172)*conc(kISPD)*cncrad(kNO3)*nflag
