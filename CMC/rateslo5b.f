...
C	ISOP -> BSOA
        Gain(kCBS2 )= +(0.0023*(1-B) + 0.0001*B )*r(189)
     &                +(0.0023*(1-B) + 0.0001*B )*r(190)
        Gain(kCBS3 )= +(0.0076*(1-B) + 0.0057*B )*r(189)
     &                +(0.0076*(1-B) + 0.0057*B )*r(190)
        Gain(kCBS4 )= +(0.0038*(1-B) + 0.0038*B )*r(189)
...
c
C	DEFINE BRANCHING RATIO FOR POA
C	FRAGMENTATION/ FUNCTIONALIZATION
C	  FUNC = 1 -> All aging gets less volatile
C	  FRAG = 1 -> All aging gets more volatile
	  FUNC = 0.7
	  FRAG = 1-FUNC

        Loss(kCPO1 )= +( 1.000)*r(212)
        ...
        Gain(kCOO1 )= +( 0.0  )*r(212)        +(FUNC)*( 1.075)*r(213) +( 0.0  )*r(214)
     &	              +( 0.0  )*r(215)	      +( 0.0  )*r(216)        +( 0.0  )*r(217)        
     &		      +( 0.0  )*r(218)	      +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)	      +(FUNC)*( 1.075)*r(221) +( 0.0  )*r(222)
     &		      +( 0.0  )*r(223)	      +( 0.0  )*r(224)        +( 0.0  )*r(225)
     &		      +( 0.0  )*r(226)        +( 0.0  )*r(227)

        Gain(kCOO2 )= +(FRAG)*( 1.075)*r(212) +( 0.0  )*r(213)        +(FUNC)*( 1.075)*r(214) 
     &		      +( 0.0  )*r(215)        +( 0.0  )*r(216)        +( 0.0  )*r(217)        
     &		      +( 0.0  )*r(218)        +( 0.0  )*r(219)
     &                +(FRAG)*( 1.075)*r(220) +( 0.0  )*r(221)        +(FUNC)*( 1.075)*r(222) 
     &		      +( 0.0  )*r(223)	      +( 0.0  )*r(224)        +( 0.0  )*r(225)        
     &		      +( 0.0  )*r(226)	      +( 0.0  )*r(227)

        Gain(kCOO3 )= +( 0.0  )*r(212)        +(FRAG)*( 1.075)*r(213) +( 0.0  )*r(214) 
     &		      +(FUNC)*( 1.075)*r(215) +( 0.0  )*r(216)        +( 0.0  )*r(217)        
     &		      +( 0.0  )*r(218)	      +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)        +(FRAG)*( 1.075)*r(221) +( 0.0  )*r(222) 
     &		      +(FUNC)*( 1.075)*r(223) +( 0.0  )*r(224)        +( 0.0  )*r(225) 
     &		      +( 0.0  )*r(226)        +( 0.0  )*r(227)

        Gain(kCOO4 )= +( 0.0  )*r(212)        +( 0.0  )*r(213)        +(FRAG)*( 1.075)*r(214)
     &		      +( 0.0  )*r(215)	      +(FUNC)*( 1.075)*r(216) +( 0.0  )*r(217)    
     &		      +( 0.0  )*r(218)        +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)        +( 0.0  )*r(221)        +(FRAG)*( 1.075)*r(222)  
     &		      +( 0.0  )*r(223)        +(FUNC)*( 1.075)*r(224) +( 0.0  )*r(225)   
     &		      +( 0.0  )*r(226)        +( 0.0  )*r(227)

        Gain(kCOO5 )= +( 0.0  )*r(212)        +( 0.0  )*r(213)        +( 0.0  )*r(214) 
     &		      +(FRAG)*( 0.0  )*r(215) +( 0.0  )*r(216)        +(FUNC)*( 1.075)*r(217) 
     &		      +( 0.0  )*r(218)        +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)        +( 0.0  )*r(221)        +( 0.0  )*r(222) 
     &		      +(FRAG)*( 1.075)*r(223) +( 0.0  )*r(224)        +(FUNC)*( 1.075)*r(225)
     &		      +( 0.0  )*r(226)	      +( 0.0  )*r(227)

        Gain(kCOO6 )= +( 0.0 )*r(212)         +( 0.0  )*r(213)        +( 0.0  )*r(214)
     &		      +( 0.0  )*r(215)        +(FRAG)*( 1.075)*r(216) +( 0.0  )*r(217) 
     &		      +(FUNC)*( 1.075)*r(218) +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)        +( 0.0  )*r(221)        +( 0.0  )*r(222) 
     &		      +( 0.0  )*r(223)        +(FRAG)*( 1.075)*r(224) +( 0.0  )*r(225) 
     &		      +(FUNC)*( 1.075)*r(226) +( 0.0  )*r(227)

        Gain(kCOO7 )= +( 0.0  )*r(212)        +( 0.0  )*r(213)        +( 0.0  )*r(214)
     &		      +( 0.0  )*r(215)        +( 0.0  )*r(216)        +(FRAG)*( 1.075)*r(217)
     &		      +( 0.0  )*r(218)        +(FUNC)*( 1.075)*r(219)
     &                +( 0.0  )*r(220)        +( 0.0  )*r(221)        +( 0.0  )*r(222)
     &		      +( 0.0  )*r(223)        +( 0.0  )*r(224)        +(FRAG)*( 1.075)*r(225)
     &		      +( 0.0  )*r(226)        +(FUNC)*( 1.075)*r(227)

        Gain(kCOO8 )= +( 0.0  )*r(212)        +( 0.0  )*r(213)        +( 0.0  )*r(214)
     &		      +( 0.0  )*r(215)        +( 0.0  )*r(216)        +( 0.0  )*r(217)
     &		      +(FRAG)*( 1.075)*r(218) +( 0.0  )*r(219)
     &                +( 0.0  )*r(220)        +( 0.0  )*r(221)        +( 0.0  )*r(222)
     &	  	      +( 0.0  )*r(223)	      +( 0.0  )*r(224)        +( 0.0  )*r(225)
     &		      +(FRAG)*( 1.075)*r(226) +( 0.0  )*r(227)


C
C-------SAPRC SOA aging reactions
C
C	DEFINE BRANCHING RATIO FOR SOA
C	FRAGMENTATION/ FUNCTIONALIZATION
C	  FUNC = 1 -> All aging gets less volatile
C	  FRAG = 1 -> All aging gets more volatile
	  FUNC = 0.5
...
c Oxidation causes one-bin volatility shift
        ...
        Gain(kCBS1 )= Gain(kCBS1 ) +( 0.0  )*r(228)        +(FUNC)*( 1.075)*r(229)
     &				   +( 0.0  )*r(230)        +( 0.0  )*r(231)
     &				   +( 0.0  )*r(232)
        Gain(kCBS2 )= Gain(kCBS2 ) +(FRAG)*( 1.075)*r(228) +( 0.0  )*r(229)
     &				   +(FUNC)*( 1.075)*r(230) +( 0.0  )*r(231)
     &				   +( 0.0  )*r(232)
        Gain(kCBS3 )= Gain(kCBS3 ) +( 0.0  )*r(228)        +(FRAG)*( 1.075)*r(229) 
     &			 	   +( 0.0  )*r(230) 	   +(FUNC)*( 1.075)*r(231)
     &				   +( 0.0  )*r(232)
        Gain(kCBS4 )= Gain(kCBS4 ) +( 0.0  )*r(228)        +( 0.0  )*r(229) 
     &			 	   +(FRAG)*( 1.075)*r(230) +( 0.0  )*r(231)
     &				   +(FUNC)*( 1.075)*r(232)
        Gain(kCBS5 )= Gain(kCBS5 ) +( 0.0  )*r(228)        +( 0.0  )*r(229) 
     &			 	   +( 0.0  )*r(230)        +(FRAG)*( 1.075)*r(231)
     &				   +( 0.0  )*r(232)

        Gain(kCAS1 )= Gain(kCAS1 ) +( 0.0  )*r(233)        +(FUNC)*( 1.075)*r(234)
     &				   +( 0.0  )*r(235)        +( 0.0  )*r(236)
     &				   +( 0.0  )*r(237)
        Gain(kCAS2 )= Gain(kCAS2 ) +(FRAG)*( 1.075)*r(233) +( 0.0  )*r(234)
     &				   +(FUNC)*( 1.075)*r(235) +( 0.0  )*r(236)
     &				   +( 0.0  )*r(237)
        Gain(kCAS3 )= Gain(kCAS3 ) +( 0.0  )*r(233)        +(FRAG)*( 1.075)*r(234) 
     &			 	   +( 0.0  )*r(235) 	   +(FUNC)*( 1.075)*r(236)
     &				   +( 0.0  )*r(237)
        Gain(kCAS4 )= Gain(kCAS4 ) +( 0.0  )*r(233)        +( 0.0  )*r(234) 
     &			 	   +(FRAG)*( 1.075)*r(235) +( 0.0  )*r(236)
     &				   +(FUNC)*( 1.075)*r(237)
        Gain(kCAS5 )= Gain(kCAS5 ) +( 0.0  )*r(233)        +( 0.0  )*r(234) 
     &			 	   +( 0.0  )*r(235)        +(FRAG)*( 1.075)*r(236)
     &				   +( 0.0  )*r(237)

        Gain(kCNS1 )= +( 0.0  )*r(238)        +(FUNC)*( 1.075)*r(239) +( 0.0  )*r(240)
     &	              +( 0.0  )*r(241)	      +( 0.0  )*r(242)        +( 0.0  )*r(243)        
     &		      +( 0.0  )*r(244)	      +( 0.0  )*r(245)

        Gain(kCNS2 )= +(FRAG)*( 1.075)*r(238) +( 0.0  )*r(239)        +(FUNC)*( 1.075)*r(240) 
     &		      +( 0.0  )*r(241)        +( 0.0  )*r(242)        +( 0.0  )*r(243)        
     &		      +( 0.0  )*r(244)        +( 0.0  )*r(245)

        Gain(kCNS3 )= +( 0.0  )*r(238)        +(FRAG)*( 1.075)*r(239) +( 0.0  )*r(240) 
     &		      +(FUNC)*( 1.075)*r(241) +( 0.0  )*r(242)        +( 0.0  )*r(243)        
     &		      +( 0.0  )*r(244)	      +( 0.0  )*r(245)

        Gain(kCNS4 )= +( 0.0  )*r(238)        +( 0.0  )*r(239)        +(FRAG)*( 1.075)*r(240)
     &		      +( 0.0  )*r(241)	      +(FUNC)*( 1.075)*r(242) +( 0.0  )*r(243)    
     &		      +( 0.0  )*r(244)        +( 0.0  )*r(245)

        Gain(kCNS5 )= +( 0.0  )*r(238)        +( 0.0  )*r(239)        +( 0.0  )*r(240) 
     &		      +(FRAG)*( 0.0  )*r(241) +( 0.0  )*r(242)        +(FUNC)*( 1.075)*r(243) 
     &		      +( 0.0  )*r(244)        +( 0.0  )*r(245)

        Gain(kCNS6 )= +( 0.0 )*r(238)         +( 0.0  )*r(239)        +( 0.0  )*r(240)
     &		      +( 0.0  )*r(241)        +(FRAG)*( 1.075)*r(242) +( 0.0  )*r(243) 
     &		      +(FUNC)*( 1.075)*r(244) +( 0.0  )*r(245)

        Gain(kCNS7 )= +( 0.0  )*r(238)        +( 0.0  )*r(239)        +( 0.0  )*r(240)
     &		      +( 0.0  )*r(241)        +( 0.0  )*r(242)        +(FRAG)*( 1.075)*r(243)
     &		      +( 0.0  )*r(244)        +(FUNC)*( 1.075)*r(245)

        Gain(kCNS8 )= +( 0.0  )*r(238)        +( 0.0  )*r(239)        +( 0.0  )*r(240)
     &		      +( 0.0  )*r(241)        +( 0.0  )*r(242)        +( 0.0  )*r(243)
     &		      +(FRAG)*( 1.075)*r(244) +( 0.0  )*r(245)
