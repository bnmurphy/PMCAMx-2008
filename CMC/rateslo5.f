...
c        B = 0.0
     ...
     &     r( 60)+r( 61)+r( 63)+r( 64)+r( 66)+r( 67)+r( 68) )
        ...
        Gain(kCAS1 )= +(0.0067*(1-B) + 0.0067*B )*r(202)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.1608*(1-B) + 0.1608*B )*r(202)
        Gain(kCAS3 )= +(0.4689*(1-B) + 0.3014*B )*r(202)
        Gain(kCAS4 )= +(0.6028*(1-B) + 0.4689*B )*r(202)
