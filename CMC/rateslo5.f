...
C	ARO1 -> ASOA  (Based on Hildebrandt et al Toluene Yields)
        Gain(kCAS1 )= +(0.0048*(1-B) + 0.0048*B )*r(202)
        Gain(kCAS2 )= +Gain(kCAS2 )+(0.1148*(1-B) + 0.1148*B )*r(202)
        Gain(kCAS3 )= +(0.3349*(1-B) + 0.2153*B )*r(202)
        Gain(kCAS4 )= +(0.4306*(1-B) + 0.3349*B )*r(202)
...
C	ISOP -> BSOA
        Gain(kCBS1 )= +(0.0023*(1-B) + 0.0001*B )*r(189)
     &                +(0.0023*(1-B) + 0.0001*B )*r(190)
        Gain(kCBS2 )= +(0.0076*(1-B) + 0.0057*B )*r(189)
     &                +(0.0076*(1-B) + 0.0057*B )*r(190)
        Gain(kCBS3 )= +(0.0038*(1-B) + 0.0038*B )*r(189)
