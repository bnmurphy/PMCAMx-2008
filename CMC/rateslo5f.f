...
c        B = 0.0
     ...
     &     r( 60)+r( 61)+r( 63)+r( 64)+r( 66)+r( 67)+r( 68) )
        ...
        Gain(kCAS1 )= +(0.0072*(1-B) + 0.0072*B )*r(202)
        Gain(kCAS2 )= +Gain(kCAS2 )+( 0.1722*(1-B) + 0.1722*B )*r(202)
        Gain(kCAS3 )= +(0.5024*(1-B) + 0.3229*B )*r(202)
        Gain(kCAS4 )= +(0.6459*(1-B) + 0.5024*B )*r(202)
