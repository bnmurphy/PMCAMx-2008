...
c
     ...
     &                +( 1.000)*r(100)
        ...
        Gain(kCA51 )= +(0.0373 )*r(52)
        Gain(kCR11 )= +(0.0036 )*r(63)
        Gain(kCR12 )= +(0.0113 )*r(63)
        Gain(kCR13 )= +(0.0281 )*r(63)
        Gain(kCR14 )= +(0.1675 )*r(63)
        Gain(kCR21 )= +(0.0057 )*r(72)
        Gain(kCR22 )= +(0.0191 )*r(72)
        Gain(kCR23 )= +(0.0530 )*r(72)
        Gain(kCR24 )= +(0.2089 )*r(72)
        Gain(kCO11 )= +(0.0013 )*r(56)+(0.0013 )*r(57)
     &                +(0.0013 )*r(58)+(0.0013 )*r(59)
        Gain(kCO12 )= +(0.0025 )*r(56)+(0.0025 )*r(57)
     &                +(0.0025 )*r(58)+(0.0025 )*r(59)
        Gain(kCO13 )= +(0.0108 )*r(56)+(0.0108 )*r(57)
     &                +(0.0108 )*r(58)+(0.0108 )*r(59)
        Gain(kCO14 )= +(0.0366 )*r(56)+(0.0366 )*r(57)
     &                +(0.0366 )*r(58)+(0.0366 )*r(59)
        Gain(kCIS1 )= +(0.0025 )*r(76)+(0.0025 )*r(77)
        Gain(kCIS2 )= +(0.0050 )*r(76)+(0.0050 )*r(77)
        Gain(kCIS3 )= +(0.0100 )*r(76)+(0.0100 )*r(77)
        Gain(kCIS4 )= +(0.1653 )*r(76)+(0.1653 )*r(77)
        Gain(kCTR1 )= +(0.0541 )*r(97)+(0.0541 )*r(98)
     &                +(0.0541 )*r(99)+(0.0541 )*r(100)
        Gain(kCTR2 )= +(0.0425 )*r(97)+(0.0425 )*r(98)
     &                +(0.0425 )*r(99)+(0.0425 )*r(100)
        Gain(kCTR3 )= +(0.1677 )*r(97)+(0.1677 )*r(98)
     &                +(0.1677 )*r(99)+(0.1677 )*r(100)
        Gain(kCTR4 )= +(0.3008 )*r(97)+(0.3008 )*r(98)
     &                +(0.3008 )*r(99)+(0.3008 )*r(100)
        Gain(kCNP1 )= +(0.0025 )*r(97)+(0.0025 )*r(98)
     &                +(0.0025 )*r(99)+(0.0025 )*r(100)
        Gain(kCNP2 )= +(0.0122 )*r(97)+(0.0122 )*r(98)
     &                +(0.0122 )*r(99)+(0.0122 )*r(100)
        Gain(kCNP3 )= +(0.0450 )*r(97)+(0.0450 )*r(98)
     &                +(0.0450 )*r(99)+(0.0450 )*r(100)
        Gain(kCNP4 )= +(0.2203 )*r(97)+(0.2203 )*r(98)
     &                +(0.2203 )*r(99)+(0.2203 )*r(100)
