...
c
     ...
     &                +( 1.000)*r(238)+( 1.000)*r(239)+( 1.000)*r(240)
     &                +( 1.000)*r(241)+( 1.000)*r(242)+( 1.000)*r(243)
     &                +( 1.000)*r(244)+( 1.000)*r(245)
     ...
     &                      +( 1.000)*r(237)+( 1.000)*r(238)
     &                      +( 1.000)*r(239)+( 1.000)*r(240)
     &                      +( 1.000)*r(241)+( 1.000)*r(242)
     &                      +( 1.000)*r(243)+( 1.000)*r(244)
     &                      +( 1.000)*r(245)
