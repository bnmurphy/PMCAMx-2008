...
c        B = 0.0
     ...
     &                +(0.0812*(1-B) + 0.0091*B )*r(196)
        Gain(kCBS2 )= +Gain(kCBS2 )+(0.0695*(1-B) + 0.0920*B )*r(193)
     &                +(0.0695*(1-B) + 0.0920*B )*r(194)
     &                +(0.0695*(1-B) + 0.0920*B )*r(195)
     &                +(0.0695*(1-B) + 0.0920*B )*r(196)
        Gain(kCBS3 )= +Gain(kCBS3 )+(0.2715*(1-B) + 0.1521*B )*r(193)
     &                +(0.2715*(1-B) + 0.1521*B )*r(194)
     &                +(0.2715*(1-B) + 0.1521*B )*r(195)
     &                +(0.2715*(1-B) + 0.1521*B )*r(196)
        Gain(kCBS4 )= +Gain(kCBS4 )+(0.4598*(1-B) + 0.3837*B )*r(193)
     &                +(0.4598*(1-B) + 0.3837*B )*r(194)
     &                +(0.4598*(1-B) + 0.3837*B )*r(195)
     &                +(0.4598*(1-B) + 0.3837*B )*r(196)
