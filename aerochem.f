...
c
c    BNM - 07/21/09 CHANGED TO ADD NTSOA
      cg(1)  = con(kcpo1)
      cg(2)  = con(kcpo2)
      cg(3)  = con(kcpo3)
      cg(4)  = con(kcpo4)
...
c
      ...
      call soap(34,soa,cg,tempk,convfac,iout,igrdchm,
...
c
      ...
      con(kcoo1)  = amax1(cg(9),bdnl(kcoo1))
      con(kcoo2)  = amax1(cg(10),bdnl(kcoo2))
      con(kcoo3)  = amax1(cg(11),bdnl(kcoo3))
      con(kcoo4)  = amax1(cg(12),bdnl(kcoo4))
      con(kcoo5)  = amax1(cg(13),bdnl(kcoo5))
      con(kcoo6)  = amax1(cg(14),bdnl(kcoo6))
      con(kcoo7)  = amax1(cg(15),bdnl(kcoo7))
      con(kcoo8)  = amax1(cg(16),bdnl(kcoo8))
      con(kcbs1)  = amax1(cg(17),bdnl(kcbs1))
      con(kcbs2)  = amax1(cg(18),bdnl(kcbs2))
      con(kcbs3)  = amax1(cg(19),bdnl(kcbs3))
      con(kcbs4)  = amax1(cg(20),bdnl(kcbs4))
      con(kcbs5)  = amax1(cg(21),bdnl(kcbs5))
      con(kcas1)  = amax1(cg(22),bdnl(kcas1))
      con(kcas2)  = amax1(cg(23),bdnl(kcas2))
      con(kcas3)  = amax1(cg(24),bdnl(kcas3))
      con(kcas4)  = amax1(cg(25),bdnl(kcas4))
      con(kcas5)  = amax1(cg(26),bdnl(kcas5))
      con(kcns1)  = amax1(cg(27),bdnl(kcns1))
      con(kcns2)  = amax1(cg(28),bdnl(kcns2))
      con(kcns3)  = amax1(cg(29),bdnl(kcns3))
      con(kcns4)  = amax1(cg(30),bdnl(kcns4))
      con(kcns5)  = amax1(cg(31),bdnl(kcns5))
      con(kcns6)  = amax1(cg(32),bdnl(kcns6))
      con(kcns7)  = amax1(cg(33),bdnl(kcns7))
      con(kcns8)  = amax1(cg(34),bdnl(kcns8))
c
      ...
      con(kaoo1)  = amax1(soa(9),bdnl(kaoo1))
      con(kaoo2)  = amax1(soa(10),bdnl(kaoo2))
      con(kaoo3)  = amax1(soa(11),bdnl(kaoo3))
      con(kaoo4)  = amax1(soa(12),bdnl(kaoo4))
      con(kaoo5)  = amax1(soa(13),bdnl(kaoo5))
      con(kaoo6)  = amax1(soa(14),bdnl(kaoo6))
      con(kaoo7)  = amax1(soa(15),bdnl(kaoo7))
      con(kaoo8)  = amax1(soa(16),bdnl(kaoo8))
      con(kabs1)  = amax1(soa(17),bdnl(kabs1))
      con(kabs2)  = amax1(soa(18),bdnl(kabs2))
      con(kabs3)  = amax1(soa(19),bdnl(kabs3))
      con(kabs4)  = amax1(soa(20),bdnl(kabs4))
      con(kabs5)  = amax1(soa(21),bdnl(kabs5))
      con(kaas1)  = amax1(soa(22),bdnl(kaas1))
      con(kaas2)  = amax1(soa(23),bdnl(kaas2))
      con(kaas3)  = amax1(soa(24),bdnl(kaas3))
      con(kaas4)  = amax1(soa(25),bdnl(kaas4))
      con(kaas5)  = amax1(soa(26),bdnl(kaas5))
      con(kans1)  = amax1(soa(27),bdnl(kans1))
      con(kans2)  = amax1(soa(28),bdnl(kans2))
      con(kans3)  = amax1(soa(29),bdnl(kans3))
      con(kans4)  = amax1(soa(30),bdnl(kans4))
      con(kans5)  = amax1(soa(31),bdnl(kans5))
      con(kans6)  = amax1(soa(32),bdnl(kans6))
      con(kans7)  = amax1(soa(33),bdnl(kans7))
      con(kans8)  = amax1(soa(34),bdnl(kans8))
c
